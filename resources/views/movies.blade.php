...
@section('content')
              ...
              <div class="container">
                ...
                <div class="progression-studios-slider-caption-width">
                  <div class="progression-studios-slider-caption-align">
                    <h2><a href="video-post.html">{{ $data['results'][0]['title'] }}</a></h2>
                    <ul class="slider-video-post-meta-list">
                      ...
                      <li class="slider-video-post-meta-year">{{ $data['results'][0]['release_date'] }}</li>
  ...
  <div id="content-pro">
    ...
    <div class="container custom-gutters-pro">
      ...
      <h2 class="post-list-heading">Populares<span>Películas en tendencia alrededor del mundo</span></h2>
        ...
        @foreach ($data['results'] as $movie)
          <div class="col col-12 col-md-6 col-lg-6">
            <div class="progression-studios-video-index-container">
              <a href="{{ route('watch', ['media_type' => 'movie', 'id' => $movie['id']]) }}">
                <div class="progression-studios-video-feaured-image"><img
                    src="{{ mediaImg('w780', $movie['backdrop_path']) }}" alt="Imagen no disponible.">
                </div>
                ...
                <div class="progression-video-index-content">
                  <div class="progression-video-index-table">
                    <div class="progression-video-index-vertical-align">
                      ...
                      <h2 class="progression-video-title">{{ $movie['title'] }}</h2>
                      ...
                      <div class="average-rating-video-post">
                        ...
                        <div class="average-rating-overflow-width" style="width:{{ $movie['vote_average'] * 10 }}%;">
                          <div class="average-rating-video-filled">
                            <span class="dashicons dashicons-star-filled"></span><span
                              class="dashicons dashicons-star-filled"></span><span
                              class="dashicons dashicons-star-filled"></span><span
                      ...
                      <ul class="video-index-meta-taxonomy">
                        @foreach ($genres as $genre)
                          @foreach (array_slice($movie['genre_ids'], 0, 1) as $id)
                            @if ($genre['id'] == $id)
                              <li>{{ $genre['name'] }}</li>
                            @endif
                          @endforeach
